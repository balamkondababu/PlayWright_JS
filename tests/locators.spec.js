...
test('practice text element with built in locators',async({page})=>{
...
test('practice text element with built in locators - 1',async({page})=>{
    ...
    await page.getByPlaceholder("Full Name").fill("kondababu")
